// =============================================================================
// settings/config/DebugConfig.qml — Debug Logging Configuration
// =============================================================================
//
// Central debug flag for gating console.log statements across the settings
// shell. Set debugEnabled to true for development, false for production.
//
// Usage:
